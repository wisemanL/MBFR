...
class SARS_Buffer :
    ...
    def add(self,s,a,r,s_next):
        ...
        self.s[self.current_pos] = torch.tensor(s, dtype=self.stype)
        self.a[self.current_pos] = torch.tensor(a, dtype=self.atype)
        self.r[self.current_pos] = torch.tensor(r, dtype=float32)
